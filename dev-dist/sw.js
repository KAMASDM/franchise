...
define(['./workbox-ee7d69d2'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^https:\/\/firestore\.googleapis\.com\/.*\/documents\/.*/i, new workbox.NetworkFirst({
